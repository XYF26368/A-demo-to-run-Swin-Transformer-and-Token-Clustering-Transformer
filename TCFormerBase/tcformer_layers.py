...
from tcformer_utils import merge_tokens, cluster_dpc_knn, token2map, map2token
...
class OverlapPatchEmbed(BaseModule):
    ...
    def __init__(self, img_size=224, patch_size=4, stride=4, in_channnels=3, embed_dim=768):
        super().__init__()
        ...
        self.proj = nn.Conv2d(self.in_channels, embed_dim, kernel_size=patch_size, stride=stride,
                              padding=(1,1))
        # self.proj  = build_conv_layer(
        #     dict(type='Conv2d'),
        #     in_channels=in_channnels,
